#!/usr/bin/env sh
# Universal installer for trialwatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/trialwatch.git"
echo "Installing trialwatch ..."
